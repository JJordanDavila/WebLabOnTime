				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8">
						<div class="row">
							...
							<div class="pull-right col-xs-12 col-sm-auto"><a href="${pageContext.request.contextPath}/solicitudes.html" class="btn btn-primary btn-labeled" id="${btnCreate}" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Regresar</a></div>
				...
				<div class="col-md-12">
					<div class="panel panel-info" style="margin-bottom: 5px;">
						<div class="panel-heading">
							<span class="panel-title">Atención de solicitudes pendientes</span>
						</div>
						<!-- / .panel-heading -->
						<div class="panel-body padding-xs-vr no-margin ">
							...
							<form action="#" method="post" id="find-interno-form">
								...
								<div class="row" style="padding-top: 10px" >
									...
									<div class="col-md-12">
										<label class="control-label no-margin-b">Diagnóstico:</label>
										<textarea id="character-limit-textarea" name="txtDescripcion" rows="6" class="form-control"></textarea>
									</div>
