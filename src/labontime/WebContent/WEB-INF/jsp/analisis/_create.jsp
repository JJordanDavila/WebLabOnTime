				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8">
						<div class="row">
							...
							<div class="pull-right col-xs-12 col-sm-auto"><a href="${pageContext.request.contextPath}/analisis/create.html" class="btn btn-primary btn-labeled" id="${btnCreate}" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Regresar</a></div>
						...
						<div class="panel-body padding-xs-vr no-margin ">
							...
							<form action="#" method="post" id="find-interno-form">
								<div class="row" style="padding-top: 5px" >
									...
									<div class="col-md-9">
										<label class="control-label no-margin-b">Descripción:</label>
										<input type="text" name="fNombre" id="fNombre" placeholder="" class="form-control input-sm">
									</div>
