	...
	<div id="main-wrapper" style="margin-top:0px;">
		...
		<div id="content-wrapper">
			...
			<div class="page-header padding-xs-vr">
				<div class="row">
					<h1 class="col-xs-12 col-sm-4 text-center text-left-sm text-primary"><i class="fa fa-home page-header-icon"></i>&nbsp;Laboratorios</h1>
					<div class="col-xs-12 col-sm-8">
						<div class="row">
							<hr class="visible-xs no-grid-gutter-h">
							<div class="pull-right col-xs-12 col-sm-auto"><a href="${pageContext.request.contextPath}/laboratorios.html" class="btn btn-primary btn-labeled" id="${btnCreate}" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Regresar</a></div>
						...
						<div class="panel-body padding-xs-vr no-margin ">
							...
							<form action="#" method="post" id="find-interno-form">
								<div class="row" style="padding-top: 5px" >
									...
									<div class="col-md-3">
										<label class="control-label no-margin-b">Nombre Laboratorio:</label>
									...
									<div class="col-md-3">
										<label class="control-label no-margin-b">Responsable:</label>
										<input type="text" name="fNombre" id="fNombre" placeholder="" class="form-control input-sm">
									</div>
									
									<div class="col-md-3">
										<label class="control-label no-margin-b">Dni responsable:</label>
										<input type="text" name="fNombre" id="fNombre" placeholder="" class="form-control input-sm">
									</div>
								...
								<div class="row" style="padding-top: 10px" >
									...
									<div class="col-md-3">
										<label class="control-label no-margin-b">Correo elctrónico:</label>
										<input type="text" name="fNombre" id="fNombre" placeholder="" class="form-control input-sm">
									</div>
