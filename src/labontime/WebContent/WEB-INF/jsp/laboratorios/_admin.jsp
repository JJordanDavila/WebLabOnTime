				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8">
						<div class="row">
							...
							<div class="pull-right col-xs-12 col-sm-auto"><a href="${pageContext.request.contextPath}/laboratorios/create.html" class="btn btn-primary btn-labeled" id="${btnCreate}" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Nuevo registro</a></div>
				...
				<div class="col-md-12">
					<div class="panel panel-info" style="margin-bottom: 5px;">
						<div class="panel-heading">
							<span class="panel-title">B&uacute;squeda de Laboratorios</span>
						</div>
						<!-- / .panel-heading -->
						<div class="panel-body padding-xs-vr no-margin ">
							<form action="" id="find-interno-form">
								<div class="row" style="padding-bottom: 5px" >
									...
									<div class="col-md-4">
										<label class="control-label no-margin-b">Laboratorio:</label>
