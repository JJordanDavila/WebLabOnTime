				...
				<div class="col-md-12">
					<div class="row" style="padding: 0px; margin: 0px;">
						...
						<div class="col-md-2 marginRight">
							<div class="iconPanel"><i class="fa fa-hospital-o">&nbsp;</i></div>
							<h4 class="padding-sm no-padding-t padding-xs-hr"><a href="${pageContext.request.contextPath}/laboratorios.html"><b>LABORATORIOS</b></a></h4>
						</div>
						<div class="col-md-2 marginRight">
							<div class="iconPanel"><i class="fa fa-gears">&nbsp;</i></div>
							<h4 class="padding-sm no-padding-t padding-xs-hr"><a href="${pageContext.request.contextPath}/analisis.html"><b>ANÁLISIS</a></b></h4>
						</div>
